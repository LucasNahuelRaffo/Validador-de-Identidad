      ...
      {modo === "idle" && (
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <button
            ...
            className="w-full border-2 border-dashed border-slate-300 hover:border-blue-400 rounded-2xl p-8 flex flex-col items-center gap-3 transition-colors disabled:opacity-50"
          >
          ...
          <label className="w-full border-2 border-dashed border-slate-300 hover:border-blue-400 rounded-2xl p-8 flex flex-col items-center gap-3 transition-colors cursor-pointer text-center">
            ...
            <div className="text-center">
              <p className="text-sm font-medium text-slate-700">Cargar archivo (PC)</p>
            </div>
          </label>
        </div>
      )}
